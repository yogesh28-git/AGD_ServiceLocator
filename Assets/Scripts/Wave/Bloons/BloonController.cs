...
namespace ServiceLocator.Wave.Bloon
{
    public class BloonController
    {
        ...
        private void SpawnLayeredBloons( ) => GameService.Instance.waveService.SpawnBloons( bloonScriptableObject.LayeredBloons,bloonView.transform.position,currentWaypointIndex,bloonScriptableObject.LayerBloonSpawnRate );
